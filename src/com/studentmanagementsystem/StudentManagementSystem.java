...
public class StudentManagementSystem {
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(
				new ImageIcon(StudentManagementSystem.class.getResource("/img/student management system.png")));
		...
		tfName.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Name", TitledBorder.LEADING,
		...
		tfEmail.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Email ID", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		tfMobile.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Mobile Number",
		...
		tfAddress.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Address", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		tfPassword.setBorder(
				new TitledBorder(null, "Enter Password", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		tfUpdateName.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Name", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		tfUpdateEmail.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Email ID",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		tfUpdateMobile.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Mobile Number",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		tfUpdateAddress.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Enter Address",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 255)));
		...
		tfUpdateID
				.setBorder(new TitledBorder(null, "Search By ID", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		tfDelete.setBorder(
				new TitledBorder(null, "Enter Id to Delete Data", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	protected void updateData() {
		...
		try {
			DBConnection.pst = DBConnection.con.prepareStatement(
					"update registration set name=?,email=?,mobile=?,address=?,password=? where id=?");
	...
	protected void insertData() {
		...
		try {
			...
			DBConnection.pst = DBConnection.con
					.prepareStatement("insert into registration(name,email,mobile,address,password) values(?,?,?,?,?)");
			DBConnection.pst.setString(1, name);
			DBConnection.pst.setString(2, email);
			DBConnection.pst.setString(3, mobile);
			DBConnection.pst.setString(4, address);
